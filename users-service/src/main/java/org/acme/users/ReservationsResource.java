...
public class ReservationsResource {
    ...
    public TemplateInstance index(@QueryParam("startDate") LocalDate startDate,
    ...
    @Produces(MediaType.TEXT_HTML)
    @Path("/available")
    public TemplateInstance getAvailableCars(@QueryParam("startDate") LocalDate startDate,
                                             @QueryParam("endDate") LocalDate endDate,
    ...
    @Produces(MediaType.TEXT_HTML)
    @Path("/reserve")
    public RestResponse<TemplateInstance> create(@QueryParam("startDate") LocalDate startDate,
                                                 @QueryParam("endDate") LocalDate endDate,
